...
$image = $metaImage ?? config('seo.default_image', 'assets/images/og-default.png');
...
<?php if (!empty($metaImage) && $metaImage !== 'assets/images/og-default.png'): ?>
<meta property="og:title" content="<?= e($title) ?>">
<meta property="og:description" content="<?= e($description) ?>">
<meta property="og:image" content="<?= e(image_url($metaImage)) ?>">
...
<meta name="twitter:image" content="<?= e(image_url($metaImage)) ?>">
<?php endif; ?>
<meta name="theme-color" content="#0d1017">
<?php foreach (['assets/css/tokens.css', 'assets/css/base.css', 'assets/css/layout.css', 'assets/css/components.css', 'assets/css/utilities.css', 'assets/css/responsive.css'] as $css): ?>
