...
<div class="error-page" style="text-align:center;padding-block:var(--space-8) 0">
  <div style="font-size:clamp(4rem,12vw,6rem);line-height:1.1;color:var(--danger);margin-block-end:var(--space-4)">
    <i class="fa-solid fa-shield-halved" aria-hidden="true"></i>
  </div>
  <h1 style="font-size:clamp(1.5rem,4vw,2.2rem);margin:0 0 var(--space-3)">403 — Access denied</h1>
